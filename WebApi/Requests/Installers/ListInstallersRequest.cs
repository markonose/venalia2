...
namespace WebApi.Requests.Installers
{
    public class ListInstallersRequest
    {
        [FromQuery]
    ...
    public class ListInstallersRequestValidator : AbstractValidator<ListInstallersRequest>
    {
        public ListInstallersRequestValidator()
        {
